...
export const CARDS = {
  ...
  sunnyday: {
    ...
    text: (v) => `전투가 끝날 때까지 불꽃 기술의 위력이 ${v.add} 오른다.`,
  },
  ...
  sandstorm: {
    ...
    text: (v) => `턴이 끝날 때마다 모든 적에게 ${v.dmg}의 피해를 준다.`,
  },
  ...
  ingrain: {
    ...
    text: (v) => `턴이 끝날 때마다 방어도 ${v.blk}를 얻는다.`,
  },
